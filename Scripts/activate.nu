...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kapis\OneDrive\Pulpit\Projekty python\yt'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kapis\OneDrive\Pulpit\Projekty python\yt\Scripts\deactivate.nu'
